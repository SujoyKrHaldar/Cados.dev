      ...
      <div className="container w-full h-full flex items-center z-10">
        <div className="space-y-4 max-w-2xl">
          <div className="space-y-3">
            ...
            <h1>
              <span className="font-bold block  "> Collaboration ?</span> you
              are at right place.
            </h1>

            <p className="max-w-md">
              At Cados we are here to help you to find and collaborate with
              other developer advocates from many companies.
            </p>
          </div>
